...
// Configuration
const apikey = 'ptla_ukQ7tqDGnJLETDYBgXQgl1j2t4I1zqKNLr3H7BOcVJd';
const capikey = 'ptlc_Enb9CS3jZQnix9GF48BwJdEqE82EeKQ6RRyUVVGqiIY';
const domain = 'https://armufaplay.my.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'animationarmufa@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '8565301426:AAFNNQI24nBVkYLIkg3xot0UPSjdrpEXBBQ';
const adminTelegramId = '7973092286';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'ARMUFA' && password === 'ARMUFA') {
    res.json({ success: true, user: { username: 'ARMUFA', role: 'admin' } });
  } else {
